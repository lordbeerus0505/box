...
//      console.log(successResponse.data)
  ...
  onDeleteAccount(userAccount) {
    ...
    var confirm = this.$mdDialog.prompt()
          .title("Would you like to remove this BOX integration with Yellowant?")
          .textContent(`Please type in your BOX handle to confirm: ${userAccount.user_invoke_name}`)
          .placeholder("BOX-handle")
          .ariaLabel("BOX Handle")
